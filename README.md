...
- ✅ **9× 實測加速**:從 x64-Prism-模擬的 RTF 13.72× 壓到 native ARM64 的 **RTF 1.74×**
- ✅ **零精度漂移**:Q8_0 與 fp16 在黃金樣本上輸出**完全相同** transcript
- ✅ **86 個 TDD 測試** + 真實 golden integration test
...
- `tests/` — 87 pytest tests (86 unit + 1 slow integration)
